...
<a href="assets/moon-jellyfish-lamp/"><img src="assets/moon-jellyfish-lamp/preview.png" width="420" alt="满月水母灯：透明伞盖、月球与柔软触须" /></a>

透明伞盖、发光月球和柔软触须组成的幻想灯具。使用 Blender 制作，包含布料与软体模拟的动画实验。

**当前：预览已公开，下载包尚未发布。** R2 接通并完成下载校验后，会在详情页更新。
...
原创模型、材质与 Blender 场景内容采用 **CC BY 4.0**：允许商用、修改和分享，须署名、附许可链接并注明修改。原创代码采用 **MIT**：允许商用与修改，分发时须保留版权和许可声明。详见 [授权说明](LICENSE.md)。第三方素材保持原许可，不纳入作者原创授权范围。
